...
\tocline{Down the Rabbit-Hole}{3}
\tocline{The Pool of Tears}{10}
\tocline{A Caucus-Race and a Long Tale}{17}
\tocline{The Rabbit Sends in a Little Bill}{25}
\tocline{Advice from a Caterpillar}{33}
\tocline{Pig and Pepper}{41}
\tocline{A Mad Tea-Party}{50}
\tocline{The Queen's Croquet-Ground}{59}
\tocline{The Mock Turtle's Story}{68}
\tocline{The Lobster Quadrille}{76}
\tocline{Who Stole the Tarts?}{85}
\tocline{Alice's Evidence}{92}
...
\onelineskip
\startline{1}{\it Alice's right foor, Esq.}
\startline{2}{\it hearthrug,}
\startline{3}{\it near the fender,}
\startline{4}{\it (with Alice's love).}
\onelineskip
...
\onelineskip
\startline{0.94}{`How doth the little crocodile}
\startline{1}{Improve his shining tail,}
\startline{1}{And pour the waters of the Nile}
\startline{1}{On every golden scale!'}
\onelineskip

\startline{0.94}{`How cheerfully he seems to grin,}
\startline{1}{How neatly spread his claws,}
\startline{1}{And welcome little fishes in}
\startline{1}{With gently smiling jaws!'}
\onelineskip
...
`That {\it was} a narrow escape!' said Alice, a good deal frightened at
...
Alice, and sighing.
  ...
  `It {\it is} a long tail, certainly,' said Alice, looking down with
wonder at the Mouse's tail; `but why do you call it sad?'  And
she kept on puzzling about it while the Mouse was speaking, so
that her idea of the tale was something like this:--
\onelineskip
\startline{3.9}{                    `Fury said to a}
\startline{3.8}{                   mouse, That he}
\startline{3.6}{                 met in the}
\startline{3.4}{               house,}
\startline{3.2}{            ``Let us}
\startline{3.3}{              both go to}
\startline{3.4}{                law:  I will}
\startline{3.6}{                  prosecute}
\startline{3.8}{                    {\it you}.  --Come,}
\startline{4.1}{                       I'll take no}
\startline{4.2}{                        denial; We}
\startline{3.9}{                     must have a}
\startline{3.5}{                 trial:  For}
\startline{3.2}{              really this}
\startline{2.9}{           morning I've}
\startline{2.8}{          nothing}
\startline{2.7}{         to do.''}
\allowbreak
\startline{2.9}{           Said the}
\startline{3.1}{             mouse to the}
\startline{3.3}{               cur, ``Such}
\startline{3.5}{                 a trial,}
\startline{3.7}{                   dear Sir,}
\startline{4.3}{                         With}
\startline{3.9}{                     no jury}
\startline{3.6}{                  or judge,}
\startline{3.4}{                would be}
\startline{3.2}{              wasting}
\startline{3.1}{             our}
\startline{3.2}{              breath.''}
\allowbreak
\startline{3.3}{               ``I'll be}
\startline{3.5}{                 judge, I'll}
\startline{3.7}{                   be jury,''}
\startline{4.3}{                         Said}
\startline{3.8}{                    cunning}
\startline{3.7}{                      old Fury:}
\startline{3.8}{                     ``I'll}
\startline{3.9}{                      try the}
\startline{4.2}{                         whole}
\startline{4.3}{                          cause,}
\startline{4.6}{                             and}
\startline{4.1}{                        condemn}
\startline{3.9}{                       you}
\startline{3.8}{                      to}
\startline{3.9}{                       death.'' '}
\onelineskip
...
the fifth bend, I think?'
  ...
  `I had {\it not}!' cried the Mouse, sharply and very angrily.
...
barrowful will do, to begin with.'
  ...
  `A barrowful of {\it what}?' thought Alice; but she had not long to
...
I used--and I don't keep the same size for ten minutes together!'
  ...
  `Can't remember {\it what} things?' said the Caterpillar.

  `Well, I've tried to say {\it ``ow, how doth the little buse bee,''} but it
all came different!' Alice replied in a very melancholy voice.

  `Repeat, {\it ``you are old, father William,''} ' said the Caterpillar.

  Alice folded her hands, and began:--

\onelineskip
\startline{0.44}{    `You are old, Father William,' the young man said,}
\startline{0.44}{      `And your hair has become very white;}
\startline{0.5}{    And yet you incessantly stand on your head--}
\startline{0.5}{      Do you think, at your age, it is right?'}
\onelineskip

\startline{0.44}{    `In my youth,' Father William replied to his son,}
\startline{0.44}{      `I feared it might injure the brain;}
\startline{0.5}{    But, now that I'm perfectly sure I have none,}
\startline{0.5}{      Why, I do it again and again.'}
\onelineskip

\startline{0.44}{    `You are old,' said the youth, `as I mentioned before,}
\startline{0.5}{      And have grown most uncommonly fat;}
\startline{0.5}{    Yet you turned a back-somersault in at the door--}
\startline{0.5}{      Pray, what is the reason of that?'}
\onelineskip

\startline{0.44}{    `In my youth,' said the sage, as he shook his grey locks,}
\startline{0.44}{      `I kept all my limbs very supple}
\startline{0.5}{    By the use of this ointment--one shilling the box--}
\startline{0.5}{      Allow me to sell you a couple?'}
\onelineskip

\startline{0.44}{    `You are old,' said the youth, `and your jaws are too weak}
\startline{0.5}{      For anything tougher than suet;}
\startline{0.5}{    Yet you finished the goose, with the bones and the beak--}
\startline{0.5}{      Pray how did you manage to do it?'}
\onelineskip

\startline{0.44}{    `In my youth,' said his father, `I took to the law,}
\startline{0.5}{      And argued each case with my wife;}
\startline{0.5}{    And the muscular strength, which it gave to my jaw,}
\startline{0.5}{      Has lasted the rest of my life.'}
\onelineskip

\startline{0.44}{    `You are old,' said the youth, `one would hardly suppose}
\startline{0.5}{      That your eye was as steady as ever;}
\startline{0.5}{    Yet you balanced an eel on the end of your nose--}
\startline{0.5}{      What made you so awfully clever?'}
\onelineskip

\startline{0.44}{    `I have answered three questions, and that is enough,'}
\startline{0.5}{      Said his father; `don't give yourself airs!}
\startline{0.5}{    Do you think I can listen all day to such stuff?}
\startline{0.5}{      Be off, or I'll kick you down stairs!'}
\onelineskip
...
serpent?'
  ...
  `It matters a good deal to {\it me},' said Alice hastily; `but I'm
...
exactly as if nothing had happened.
  ...
  `{\it Are} you to get in at all?' said the Footman.  `That's the
...
\onelineskip
\startline{0.94}{        `Speak roughly to your little boy,}
\startline{1}{          And beat him when he sneezes:}
\startline{1}{        He only does it to annoy,}
\startline{1}{          Because he knows it teases.'}
\onelineskip

\startline{1}{                    \it Chorus.}
\onelineskip

\startline{1}{    (In which the cook and the baby joined):--}
\onelineskip

\startline{0.94}{                `Wow! wow! wow!'}
\onelineskip
...
\startline{0.94}{        `I speak severely to my boy,}
\startline{1}{          I beat him when he sneezes;}
\startline{1}{        For he can thoroughly enjoy}
\startline{1}{          The pepper when he pleases!'}
\onelineskip
...
\onelineskip
\startline{0.9}{            ``Twinkle, twinkle, little bat!}
\startline{1}{            How I wonder what you're at!''}
\onelineskip
...
\onelineskip
\startline{0.9}{            ``Up above the world you fly,}
\startline{1}{            Like a tea-tray in the sky.}
\startline{1}{                    Twinkle, twinkle--'' '}
\onelineskip
...
I can't take more.'
  ...
  `You mean you can't take {\it less},' said the Hatter:  `it's very
...
\onelineskip
\startline{0.5}{    `'Tis the voice of the Lobster; I heard him declare,}
\startline{0.5}{    ``You have baked me too brown, I must sugar my hair.''}
\startline{0.6}{    As a duck with its eyelids, so he with his nose}
\startline{0.6}{    Trims his belt and his buttons, and turns out his toes.'}
\onelineskip
\startline{0.6}{    [later editions continued as follows:}
\startline{0.6}{    When the sands are all dry, he is gay as a lark,}
\startline{0.6}{    And will talk in contemptuous tones of the Shark,}
\startline{0.6}{    But, when the tide rises and sharks are around,}
...
\onelineskip
\startline{0.54}{    `I passed by his garden, and marked, with one eye,}
\startline{0.6}{    How the Owl and the Panther were sharing a pie--'}
\onelineskip
\startline{0.6}{    [later editions continued as follows:}
\startline{0.6}{    The Panther took pie-crust, and gravy, and meat,}
\startline{0.6}{    While the Owl had the dish as its share of the treat.}
\startline{0.6}{    When the pie was all finished, the Owl, as a boon,}
\startline{0.6}{    Was kindly permitted to pocket the spoon:}
\startline{0.6}{    While the Panther received knife and fork with a growl,}
...
\onelineskip
\startline{0.94}{    `Beautiful Soup, so rich and green,}
\startline{1}{    Waiting in a hot tureen!}
\startline{1}{    Who for such dainties would not stoop?}
\startline{1}{    Soup of the evening, beautiful Soup!}
\startline{1}{    Soup of the evening, beautiful Soup!}
\startline{2}{        Beau--ootiful Soo--oop!}
\startline{2}{        Beau--ootiful Soo--oop!}
\startline{1}{    Soo--oop of the e--e--evening,}
\startline{2}{        Beautiful, beautiful Soup!}
\onelineskip

\startline{0.94}{    `Beautiful Soup!  Who cares for fish,}
\startline{1}{    Game, or any other dish?}
\startline{1}{    Who would not give all else for two}
\startline{1}{    Pennyworth only of beautiful Soup?}
\startline{1}{    Pennyworth only of beautiful Soup?}
\startline{2}{        Beau--ootiful Soo--oop!}
\startline{2}{        Beau--ootiful Soo--oop!}
\startline{1}{    Soo--oop of the e--e--evening,}
\startline{2}{        Beautiful, beauti--{\it ful soup}!'}
\onelineskip
...
\onelineskip
\startline{1}{    `The Queen of Hearts, she made some tarts,}
\startline{2}{          All on a summer day:}
\startline{1}{      The Knave of Hearts, he stole those tarts,}
\startline{2}{          And took them quite away!'}
\onelineskip
...
the week before.
  ...
  `Oh, I {\it beg} your pardon!' she exclaimed in a tone of great
...
first really clever thing the King had said that day.
  ...
  `That {\it proves} his guilt,' said the Queen.
...
\onelineskip
\startline{1}{        `They told me you had been to her,}
\startline{2}{          And mentioned me to him:}
\startline{1}{        She gave me a good character,}
\startline{2}{          But said I could not swim.}
\onelineskip

\startline{1}{        He sent them word I had not gone}
\startline{2}{          (We know it to be true):}
\startline{1}{        If she should push the matter on,}
\startline{2}{          What would become of you?}
\onelineskip

\startline{1}{        I gave her one, they gave him two,}
\startline{2}{          You gave us three or more;}
\startline{1}{        They all returned from him to you,}
\startline{2}{          Though they were mine before.}
\onelineskip

\startline{1}{        If I or she should chance to be}
\startline{2}{          Involved in this affair,}
\startline{1}{        He trusts to you to set them free,}
\startline{2}{          Exactly as we were.}
\onelineskip

\startline{1}{        My notion was that you had been}
\startline{2}{          (Before she had this fit)}
\startline{1}{        An obstacle that came between}
\startline{2}{          Him, and ourselves, and it.}
\onelineskip

\startline{1}{        Don't let him know she liked them best,}
\startline{2}{          For this must ever be}
\startline{1}{        A secret, kept from all the rest,}
\startline{2}{          Between yourself and me.'}
\onelineskip
...
believe there's an atom of meaning in it.'
  ...
  The jury all wrote down on their slates, `{\it she} doesn't believe
